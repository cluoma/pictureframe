...
PASSWORD=\"password\"
WAV_FILE=\"/home/colin/Documents/notifyme/notify.wav\"
...
pictureframe_notify:
	gcc -o pictureframe.cgi -std=c99 -DNOTIFY_WAV=$(WAV_FILE) -DPICTURE_FILE_PATH=$(PICTURE_FILE_PATH) -DSQLITE_DB_FILE=$(SQLITE_DB_FILE) -Wall -O3 -D_GNU_SOURCE src/pictureframe.c src/multipart_parser.c src/db_interface.c -lsqlite3
